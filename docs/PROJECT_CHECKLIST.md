...
- [x] Pilot batch error triage: multi-file selection, deterministic unreadable-file warnings, retry/remove controls, and local queueing. Remaining production worker and facility integrations are tracked in later backend milestones.
